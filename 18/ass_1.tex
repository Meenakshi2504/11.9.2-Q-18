...
\\\solution
 \begin{table}[!ht]
    \centering
        \input{/home/meena/tables/table1.tex}
...
\end{align}
\begin{align}
      \left(\frac{1}{\brak{1-z^{-1}}^2}\right)&\system{ Z^{-1}}\brak{n+1}u\brak{n} \hspace{5pt} |z|>1\label{eq:11.9.2.18.9} \\
    \left(\frac{z^{-1}}{\brak{1-z^{-1}}^3}\right)&\system{ Z^{-1}}\frac{\brak{n}\brak{n-1}}{2}u\brak{n-1} \hspace{5pt} |z|>1\label{eq:11.9.2.18.10} 
\end{align}
...
\begin{figure}[h]
\centering
 \includegraphics[width=0.5\columnwidth]{/home/meena/figs/python.1(1).png} 
