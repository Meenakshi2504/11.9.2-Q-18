...
Seperating terms ,
\begin{align}
     Y(Z)& = 120 \left[\frac{1}{1-z^{-1}} + \frac{z^{-1}}{(1-z^{-1})^2}\right] \nonumber \\
    &\quad +\frac{5}{2}\left[-\frac{d}{dz}\left(\frac{1}{1-z^{-1}} + \frac{z^{-1}}{(1-z^{-1})^2}\right)\right] \hspace{5pt} |z|>1
\end{align}
Taking the inverse Z-transform and applying the derivative property ,
\begin{align}
    y(n)&=\left(120(n+1)+\frac{5}{2}n(n+1)\right)u(n)\\
