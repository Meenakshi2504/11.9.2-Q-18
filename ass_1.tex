...
\end{align}
\begin{align}
     Z^{-1}\left[\frac{1}{\brak{1-z^{-1}}^2}\right]&=\brak{n+1}u\brak{n}\label{eq:11.9.5.26.9} \\
     Z^{-1}\left[\frac{z^{-1}}{\brak{1-z^{-1}}^3}\right]&=\frac{\brak{n}\brak{n-1}}{2}u\brak{n-1}\label{eq:11.9.5.26.10} 
\end{align}
