...
\begin{align}
    X(z)U(z)&=\sum\limits_{n=-\infty}^{\infty}(180n-180)z^{-n}u(n)
\end{align}
\begin{equation}
    \brak{\frac{x(0)}{1-z^{-1}} + \frac{dz^{-1}}{(1-z^{-1})^2}} \cdot \frac{1}{1-z^{-1}} \hspace{5pt} \big|z| > 1 = \sum\limits_{n=0}^{\infty} (180n - 180)z^{-n}
\end{equation}
\begin{align}
    \frac{120}{(1-z^{-1})^2} + \frac{5z^{-1}}{(1-z^{-1})^3}&=\frac{180}{1-z^{-1}} - \frac{180z^{-1}}{(1-z^{-1})^2}\hspace{5pt} \big|z| > 1
\end{align}
\begin{align}
    120 \left[\frac{1}{1-z^{-1}} + \frac{z^{-1}}{(1-z^{-1})^2}\right] &+ \frac{5}{2}\left[-\frac{d}{dz}\brak{\frac{1}{1-z^{-1}} + \frac{z^{-1}}{(1-z^{-1})^2}}\right] 
    - \frac{180}{1-z^{-1}} +\frac{180z^{-1}}{(1-z^{-1})^2} &= 0
\end{align}
Taking inverse Z- transform on both sides 
\begin{align}
120(n+1)u[n-1] + \frac{5}{2}n(n+1)u[n-1] - 180nu[n] + 180u[n+1] = 0
\end{align}

\begin{align}
    \frac{n+1}{2}\left(240 +5n \right)u[n]-180n u[n]+180u[n+1]=0
\end{align}
\begin{align}
    (n+1)(240+5n)-360n+360&=0 \forall n\geq 1\\
\end{align}
now replace n by n-1: 
\begin{align}
    n(235+5n)-360(n-1)+360&=0\\
    5n^2-125n+720&=0
    \end{align}
